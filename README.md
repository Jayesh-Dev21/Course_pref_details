...
- **Batch history** — click any course to expand scrollable details grouped by semester
- **Vim keys** — `j`/`k` to navigate, `Enter` to expand details, `Space` to like/unlike
- **Dark mode** — sun/moon toggle, persisted to localStorage
- **Export** — copy preference list as text, or save page as PDF
